...
angular.module('myApp.controllers', [])
   ...
   .controller('ReqsCtrl', ['$scope', 'syncData', function($scope, syncData) {
      $scope.newReq = null;

      // constrain number of reqs by limit into syncData
      // add the array into $scope.messages
      $scope.reqs = syncData('reqs');

      // add new messages to the list
      $scope.addReq = function() {
         if( $scope.newReq ) {
            $scope.reqs.$add({title: $scope.newReq});
            $scope.newReq = null;
         }
      };
